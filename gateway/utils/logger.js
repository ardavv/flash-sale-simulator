...
/**
 * Structured logger for the Order Gateway.
 *
 * Log format:
 *   [ISO_TIMESTAMP] [LEVEL    ] [COMPONENT] MESSAGE {context_json}
 *
 * Example:
 *   [2025-01-15T10:30:01.234Z] [INFO     ] [GATEWAY] Server started { port: 3000 }
 */
 ...
 *
 * @param {string} component  Name that appears in the [COMPONENT] field, e.g. "GATEWAY"
